  ...
  return (
    <div>
      ...
      <main className="container">
        <h1 className="text-center mt-4 mb-4">Countries</h1> {/* Centered title */}
        
        {/* Summary below the word "Countries" */}
        <p className="text-center mb-4">
        Recognition as a sovereign state is vital for Palestine, as it affirms its identity, enables participation in global diplomacy, and facilitates access to humanitarian aid. This legitimacy is essential for advocating its rights and seeking justice on the international stage. 
        During times of war, these asylum countries are crucial as they provide safety and stability for those fleeing conflict, allowing displaced individuals to rebuild their lives. Asylum countries also promote international solidarity and raise awareness of the struggles faced by those affected by violence, making recognition and asylum essential in protecting and uplifting communities in crisis.
        The following countries have shown support for Palestine and have provided asylum to refugees during the conflict:
        </p>
